...
namespace RootMotion.FinalIK {
	...
	public class FBIKChain {
		...
		public class ChildConstraint {
			 ...
			 * Constructor
			 * */
			public ChildConstraint(Transform bone1, Transform bone2, float pushElasticity, float pullElasticity) {
				this.bone1 = bone1;
				this.bone2 = bone2;
		 ...
		 * */
		public void SolveTrigonometric(FBIKChain[] chain, bool calculateBendDirection) {
			if (!initiated) return;
