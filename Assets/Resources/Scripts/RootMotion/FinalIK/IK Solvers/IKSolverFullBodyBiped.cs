...
namespace RootMotion.FinalIK {
	...
	public class IKSolverFullBodyBiped : IKSolverFullBody {
		...
		/// </summary>
		public void SetChainWeights(FullBodyBipedChain c, float pull, float reach) {
		...
		public void SetToReferences(BipedReferences references, Transform rootNode) {
			...
			chain[0].childConstraints = new FBIKChain.ChildConstraint[4] {
				...
				new FBIKChain.ChildConstraint(references.leftUpperArm, references.rightUpperArm, 0, 0),
				new FBIKChain.ChildConstraint(references.leftThigh, references.rightThigh, 0, 0)
			...
			limbMappings[2].SetBones(references.leftThigh, references.leftCalf, references.leftFoot, null);
			limbMappings[3].SetBones(references.rightThigh, references.rightCalf, references.rightFoot, null);
